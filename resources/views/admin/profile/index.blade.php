        ...
        <div class="my-auto">
            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.staff')}}">Thông tin nhân viên</a></li>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.editProfile') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select @error('role') is-invalid @enderror" name="role" id="" disabled >
                                @if($staff->role == 1)
