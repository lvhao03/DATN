            ...
            <div class="header-element">
                <div class="horizontal-logo">
                    <a href="index.html" class="header-logo">
                        <img src="{{ asset('assets/admin/images/brand-logos/desktop-logo.png') }}"
                            alt="logo" class="desktop-logo">
                        <img src="{{ asset('assets/admin/images/brand-logos/toggle-logo.png') }}"
                            alt="logo" class="toggle-logo">
                        <img src="{{ asset('assets/admin/images/brand-logos/desktop-white.png') }}"
                            alt="logo" class="desktop-white">
                        <img src="{{ asset('assets/admin/images/brand-logos/toggle-white.png') }}"
        ...
        <div class="header-content-right">
                ...
                <ul class="main-header-dropdown dropdown-menu dropdown-menu-end country-dropdown"
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span>
                                <img src="{{ asset('assets/admin/images/flags/french_flag.jpg') }}"
                                    alt="img" class="avatar avatar-xs lh-1 me-2">
                            </span>
                            French
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span>
                                <img src="{{ asset('assets/admin/images/flags/germany_flag.jpg') }}"
                                    alt="img" class="avatar avatar-xs lh-1 me-2">
                            </span>
                            German
                        </a>
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span>
                                <img src="{{ asset('assets/admin/images/flags/italy_flag.jpg') }}"
                                    alt="img" class="avatar avatar-xs lh-1 me-2">
                            </span>
                            Italian
                        </a>
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span>
                                <img src="{{ asset('assets/admin/images/flags/russia_flag.jpg') }}"
                                    alt="img" class="avatar avatar-xs lh-1 me-2">
                            </span>
                            Russian
                        </a>
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                            <span>
                                <img src="{{ asset('assets/admin/images/flags/spain_flag.jpg') }}"
                                    alt="img" class="avatar avatar-xs lh-1 me-2">
                            </span>
                            Spanish
                        </a>
                ...
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end main-header-message"
                    ...
                    <ul class="list-unstyled mb-0" id="header-cart-items-scroll">
                        <li class="dropdown-item">
                            <div class="d-flex messages">
                                <span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">
                                    <img src="{{ asset('assets/admin/images/faces/12.jpg') }}"
                                        alt="img">
                                </span>
                                <div>
                                    <div class="d-flex">
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex messages">
                                <span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">
                                    <img src="{{ asset('assets/admin/images/faces/3.jpg') }}" alt="img">
                                </span>
                                <div>
                                    <div class="d-flex">
                                        <a href="chat.html">
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex messages">
                                <span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">
                                    <img src="{{ asset('assets/admin/images/faces/5.jpg') }}" alt="img">
                                </span>
                                <div>
                                    <div class="d-flex">
                                        <a href="chat.html">
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex messages">
                                <span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">
                                    <img src="{{ asset('assets/admin/images/faces/4.jpg') }}" alt="img">
                                </span>
                                <div>
                                    <div class="d-flex">
                                        <a href="chat.html">
                        ...
                        <li class="dropdown-item">
                            <div class="d-flex messages">
                                <span class="avatar avatar-md me-2 online avatar-rounded flex-shrink-0">
                                    <img src="{{ asset('assets/admin/images/faces/1.jpg') }}" alt="img">
                                </span>
                                <div>
                                    <div class="d-flex">
                                        <a href="chat.html">
            ...
            <div class="header-element headerProfile-dropdown">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile"
                    ...
                    <img src="{{ asset('assets/admin/images/faces/6.jpg') }}" alt="img" width="37"
                ...
                <ul class="main-header-dropdown dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu"
                        ...
                        <div class="main-header-profile bg-primary menu-header-content text-fixed-white">
                            <div class="my-auto">
                                <h6 class="mb-0 lh-1 text-fixed-white">{{ \Auth::user()->name }}</h6><span
                                    class="fs-11 op-7 lh-1">Nhân viên</span>
                            </div>
                        </div>
                    </li>
                    ...
                    <li><a class="dropdown-item d-flex" href="/logout"><i
                                class="bx bx-log-out fs-18 me-2 op-7"></i>Đăng xuất</a></li>
                </ul>
            </div>
            <!-- End::header-element -->
